                        ...
                        <div class="header-top-right">
                            <ul>
                                ...
                                <li class="header-top-login">
                                    <a href="login-register.php"><i class="far fa-user-circle"></i> LOGIN</a>
        ...
        <section class="slider-area">
            <div class="slider-active">
                <div class="single-slider">
                    ...
                    <div class="slider-bg" data-background="img/slider/slider_bg01.jpg"></div>
                    <div class="container custom-container">
                        <div class="row">
                            <div class="col-xl-5 col-lg-6">
                                <div class="slider-content">
                                    <span data-animation="fadeInUp" data-delay=".3s">Best motorcycle service</span>
                                    <h2 data-animation="fadeInUp" data-delay=".6s">Professional Service Provide</h2>
                                    <p data-animation="fadeInUp" data-delay=".9s">Find the Perfect Motorcycle With Our Motorcycle Finder Tool</p>
                                    <a href="#" class="btn" data-animation="fadeInUp" data-delay="1.2s"><span>+</span> discover more</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="single-slider">
                    ...
                    <div class="container custom-container">
                        <div class="row">
                            <div class="col-xl-5 col-lg-6">
                                <div class="slider-content">
                                    <span data-animation="fadeInUp" data-delay=".3s">best auto service</span>
                                    <h2 data-animation="fadeInUp" data-delay=".6s">Professional Service Provide</h2>
                                    <p data-animation="fadeInUp" data-delay=".9s">Find the Perfect Car With Our Car Finder Tool</p>
                                    <a href="#" class="btn" data-animation="fadeInUp" data-delay="1.2s"><span>+</span> discover more</a>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from themebeyond.com/html/carnation/carnation/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 07 Feb 2021 15:35:14 GMT -->
