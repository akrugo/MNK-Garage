...
$sql = "SELECT * from moto where marque='$id'";
                        ...
                        <div class="inventory-list-item">
                            ...
                            <div class="inventory-list-content">
                                ...
                                <div class="inv-item-meta">
                                    <ul>
                                        <li class="call" style="cursor: pointer;"><a> Reserver </a></li>
                                        <li>Permis : <?php echo($moto['type_permis']); ?></li>
                                        <li>Disponibile :<?php echo($moto['disponibilité']); ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-contact">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <span>address</span>
                                            <p>Beni-Mellal Houda 2, bloc 3, Maroc</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
